...
@section('content')
    ...
    <form method="POST" action="{{ route('alliance.join') }}">
        @csrf
        <input type="hidden" name="alliance_id" value="1"> <!-- Or whatever the faction ID is -->
        <button type="submit" class="ipiHintable">
            <span>Join The Voidborn</span>
        </button>
    </form>
</li>
                            <li>
                    ...
                    <div class="alliance_wrapper">
                        ...
                        <div class="createNewAlliance" rel="{{ route('alliance.ajax.create') }}"></div>
